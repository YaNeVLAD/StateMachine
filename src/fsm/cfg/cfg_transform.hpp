...
inline constexpr left_factor_t left_factor{};
...
template <typename T_Symbol, typename T_Comp>
basic_cfg<T_Symbol, T_Comp> operator|(const basic_cfg<T_Symbol, T_Comp>& grammar, left_factor_t)
{
	return algorithms::left_factor(grammar);
}
} // namespace fsm::transforms
